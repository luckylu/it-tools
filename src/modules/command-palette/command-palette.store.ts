...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/CorentinTh/kit-for-dev',
      category: 'External',
      description: 'View the source code of Kit For Dev on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve Kit For Dev.',
      href: 'https://github.com/CorentinTh/kit-for-dev/issues/new/choose',
      category: 'Actions',
