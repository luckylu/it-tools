...
monaco.editor.defineTheme('kit-for-dev-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('kit-for-dev-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'kit-for-dev-dark' : 'kit-for-dev-light'),
  { immediate: true },
);
